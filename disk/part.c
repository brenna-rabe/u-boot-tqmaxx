...
{
	printf("Beginning function part_driver_lookup_type in disk/part.c\n");
	...
	/* Not found */
	printf("Ending function part_driver_lookup_type in disk/part.c. No part driver was found!!\n");
	return NULL;
}
...
{
	printf("Beginning function part_get_info in disk/part.c\n");
#ifdef HAVE_BLOCK_DEVICE
	struct part_driver *drv;
...
#endif /* HAVE_BLOCK_DEVICE */
	printf("Ending function part_get_info in disk/part.c and returning -1\n");
	return -1;
}
